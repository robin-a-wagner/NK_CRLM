...
The above results are consistent with expectations. We expect a large proportion of samples will go unclassified as the CMS system is poorly-tailored to metastases. Nonetheless, we expect there to be a higher level of immune infiltration in CMS1 and CMS4 tumours. 
...
These results are also consistent with expectations, because we know that iCMS3 tumours resemble immune-active MSI-H tumours. However, there are clearly both NK high and low samples in iCMS3. This is consistent with the presence of fribrosis + associated immune infiltration being orthogonal to intrinsic CMS. How can we measure the fibrosis to see whether that dilineates the high and low samples? It's not clear how Joanito et al. do so. 
